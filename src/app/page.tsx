...
export default function Home() {
  ...
  return (
    <>
      {/* Header Navigation */}
      <header className="fixed top-0 left-0 right-0 z-[100] bg-[#161a22]/80 backdrop-blur-md border-b border-[#bfa76f]/20 shadow-lg">
      ...
      <main className="min-h-screen w-full bg-[#0f1115] bg-contain bg-center bg-no-repeat">
        <div
          id="home"
          className="pt-32 text-6xl flex flex-row font-bold text-[#e5e7eb] hover:text-[#bfa76f] transition-colors duration-300"
        >
        ...
        >
          ...
          <p className="text-[#e5e7eb] hover:text-[#bfa76f] transition-colors duration-300">
            ...
            specialize in full-stack development and artificial intelligence,
            with a deep passion for building software that creates meaningful,
            real-world impact. My technical toolkit includes JavaScript
            (React.js, Node.js, Express.js) for dynamic front-end and back-end
            development, Python for AI/ML and automation, and C++ for
            algorithmic and systems programming. I also work with tools like
            FastAPI, Supabase, and Tailwind CSS to build scalable, efficient,
            and user-centered applications. I love exploring the intersection of
            design and functionality; transforming ideas into intuitive,
            performant products that solve real problems.
          </p>
        </section>
        ...
        <section
          id="projects"
          ref={sectionRef4}
          className="opacity-0 translate-y-2 transition-all duration-700 ease-out mx-auto max-w-6xl text-center mb-32"
        >
